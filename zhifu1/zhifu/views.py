...
def Acl(request):
    if request.method == "GET":
        ...
        sip1 = request.POST.get("sip1").strip()
        dip1 = request.POST.get("dip1").strip()
        dport1 = request.POST.get("sport1").strip()
        if bool(dport1) is False:
            dport1=str(0)
        else:
            dport1=dport1
        #=================================
        sip2 = request.POST.get("sip2").strip()
        dip2=request.POST.get("dip2").strip()
        dport2 = request.POST.get("dport1").strip()
